...
\response{false}{Very short n.y.c.r.}

\response{true}{Very short c.r.}

\response{false}{Short not yet completed respond to the Authors.}

\response{true}{Short completed respond to the Authors.}

\response{false}{Very long completed respond to the Authors. In order to satisfy this and also the demands of the other reviewers, the fitness
function was defined as [in pag. 6, para. 3.1.4]:}

\response{true}{Very long not yet completed respond to the Authors. In order to satisfy this and also the demands of the other reviewers, the fitness
function was defined as [in pag. 6, para. 3.1.4]. To make this response even longer, we write it two times. In order to satisfy this and also the demands of the other reviewers, the fitness function was defined as [in pag. 6, para. 3.1.4]. }

\comment{Really short comment}
...
\response{true}{In order to satisfy this and also the demands of the other reviewers, the fitness
function was defined as [in pag. 6, para. 3.1.4]:}
...
\response{true}{Authors thanks the Reviewer 1 for his/her comment. The parameter maximum
